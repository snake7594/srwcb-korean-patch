...
run("5/7 Z_SMAP 한글 그래픽", "build_zsmap_ko.py")
run("6/7 예고 타이틀 카드 그래픽", str(HERE.parent / "tools" / "graphics" / "build_effect_ko.py"))
run("7/7 patch image + write cue", "patch_iso.py")
