#requires -version 3
# 슈퍼로봇대전 컴플리트 박스 한글패치 v0.11.0 (제2차 + 제3차 + EX 전체) 적용 엔진
...
$patch   = Join-Path $root 'srwcb-second-third-ex-korean-v0.11.0.xdelta'

$T1NAME  = 'Super Robot Taisen Complete Box (Track 1).bin'
$T2NAME  = 'Super Robot Taisen Complete Box (Track 2).bin'
$OUTNAME = 'Super Robot Taisen Complete Box Korean v0.11.0 (Track 1).bin'
$CUENAME = 'Super Robot Taisen Complete Box Korean v0.11.0.cue'

$EXP_SRC   = '3f25650b588774d55c3bbb5b771779beab408eaca020e9a622133ade323a0f94'
$EXP_OUT   = 'b34a9edf66a5118273b158b1beed0ab31f13e070faef8ca7b8b0788d93e9ee41'
$EXP_PATCH = '7d4e3b53eac220749d120b455f8f86a9d18bb1c0c6b5eff03f71bd2307420161'
...
try {
    Write-Host ''
    Write-Host '============================================================'
    Write-Host '   슈퍼로봇대전 컴플리트 박스 한글패치 v0.11.0'
    Write-Host '   (제2차 + 제3차 + EX 전체)'
    Write-Host '============================================================'
    Write-Host ''

    if (-not (Test-Path -LiteralPath $xdelta)) { Fail "xdelta.exe 가 없습니다. 패치 파일들을 한 폴더에 함께 두세요." }
    if (-not (Test-Path -LiteralPath $patch))  { Fail "srwcb-second-third-ex-korean-v0.11.0.xdelta 가 없습니다." }
